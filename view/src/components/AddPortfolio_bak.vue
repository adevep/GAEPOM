...
export default {
  ...
  methods: {
    savePortfolio() {
      var data = {
        pfSubtitle: this.portfolio.pfSubtitle,
        pfDuration: this.portfolio.pfDuration,
        pfDescription: this.portfolio.pfDescription,
        participation: this.portfolio.participation,
        pfLang: this.portfolio.pfLang,
        pfTools: this.portfolio.pfTools,
        pfDbms: this.portfolio.pfDbms,
        pfLink: this.portfolio.pfLink,
        pfCategory: this.portfolio.pfCategory,
      };
