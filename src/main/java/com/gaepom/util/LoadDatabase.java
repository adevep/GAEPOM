...
public class LoadDatabase {
	...
	CommandLineRunner initDatabase(UserRepository repository, ProjectRecruitRepository repoRecruit, ProjectRepository repoProj ) {
		...
		return args -> {
			...
			log.info("Preloading " + repository.save(new User("apple77","pear123","도봉순",30,"apple@naver.com","010-1234-9384","경기도시흥시","Java,TensorFlow,Vue.js,React","img","개발자", null, null)));
			log.info("Preloading " + repository.save(new User("ch1020","hello","최유진",28,"youlove@naver.com","010-9078-9090","서울특별시광진구","MicrosoftSuite,AdobeXD","img","기획자", null, null)));
